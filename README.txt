...
4 Day | 10/11 - created some custom features, changed the architecture as dist is the folder for minified/treated files, also created the html structure for the fourth block.